"""Phase 4: MCP Client — Semantic Search

Builds on Phase 3 by adding semantic search as an MCP tool.
The LLM can now find related clinical concepts by meaning,
...
async def run_test_queries(
    ...
    print_header("Phase 4: Semantic Search — Running Test Queries")
...
async def interactive_mode(
    ...
    print_header("Phase 4: Semantic Search — Interactive Mode")
...
async def main():
    parser = argparse.ArgumentParser(
        description="Phase 4: Semantic Search clinical intelligence tool"
    )
