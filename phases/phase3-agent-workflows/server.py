"""Phase 2: MCP Server — clinical-intelligence with Knowledge Graph

Builds on Phase 1 by adding:
- A NetworkX knowledge graph built on startup from clinic DB + FDA data
- Graph traversal tools (find_path, get_neighbors, get_graph_stats, etc.)
- MCP prompts (reusable prompt templates for structured workflows)

The graph bridges public FDA drug data and private clinic records
through NDC codes. The MCP tools expose traversal. The prompts
guide the LLM through structured analysis patterns.
"""
...
# --- Build graph on import (server startup) ---
# In a production server you'd do this in a lifespan handler.
# Here we build it at module level so all tools can access it.
KG: nx.DiGraph = None


@asynccontextmanager
async def lifespan(server: FastMCP):
    """Build the knowledge graph on server startup."""
    global KG
    KG = build_graph()
...
# ===================================================================
# Resources (same as Phase 1 + graph stats)
# ===================================================================
...
# ===================================================================
# Clinic DB tools (same as Phase 1)
# ===================================================================
...
# ===================================================================
# Knowledge Graph tools (NEW in Phase 2)
# ===================================================================
...
# ===================================================================
# MCP Prompts (NEW in Phase 2)
# Reusable templates that guide the LLM through structured workflows.
# ===================================================================
...
5. Calculate the risk score using calculate_risk_score with:
...
6. Format results using format_report
...
def explore_drug(drug_name: str) -> str:
    """Comprehensive drug exploration — FDA data, clinic usage, adverse events, interactions."""
